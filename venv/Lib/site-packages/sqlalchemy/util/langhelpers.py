    ...
    def __init__(
        ...
        **kw: Any,
        ...
        for k, v in dict_.items():
            # Python 3.14 injects bookkeeping ints like __firstlineno__ and
            # __static_attributes__ into the class dict. These are not actual
            # enum members, so skip any private/dunder names up front.
            if k.startswith("_"):
                continue
            ...
            remaining = set(cls.__dict__).difference(
                {
                    ...
                    "__orig_bases__",
                    "__annotations__",
                    # Python 3.14 injects these bookkeeping attributes on
                    # classes created with typing.Generic, so allow them to
                    # keep TypingOnly usable on newer interpreters.
