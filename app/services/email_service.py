...
def _frontend_base_url() -> str:
    ...
    if not base_url or "your-frontend-domain.com" in base_url:
...
def send_password_reset_email(to_email: str, reset_token: str) -> bool:
    reset_url = f"{_frontend_base_url()}/login?reset_token={reset_token}&email={to_email}"
    body = (
...
def send_email_verification_email(to_email: str, verification_token: str) -> bool:
    verify_url = f"{_frontend_base_url()}/login?verify_token={verification_token}&email={to_email}"
    body = (
